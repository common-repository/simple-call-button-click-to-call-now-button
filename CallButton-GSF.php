<?php
/*
Plugin Name: Simple Call Button - Click to Call Now Button
Description: Display a quick call now button on posts, pages, or template via widget and shortcode.
Version: 1.0
...
$PLUGINMATRIX_NAME='Call_button';

if(!class_exists($PLUGINMATRIX_NAME))
{
    class Call_button extends WP_Widget
    {
